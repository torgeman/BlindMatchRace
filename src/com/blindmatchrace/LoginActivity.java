...
public class LoginActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		/**
		 * OREN: Fixing Gps off crash Problem
		 */
	...
	private void initialize() {
		 ...
		 * Oren : Exit Buttons
		 */
		findViewById(R.id.ExitL).setOnClickListener(new View.OnClickListener() {
	...
	/**
	 * OREN: building the error alert massage the fix gps crash
	 */
	private void buildAlertMessageNoGps() {
		AlertDialog.Builder builder = new AlertDialog.Builder(LoginActivity.this);
		builder.setMessage("Your GPS must be enable \n to use this app")
		.setCancelable(false)
	...
	public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
		...
		protected Boolean doInBackground(Void... params) {
			...
			/**
			 * OREN: Check if the Event is exist!! (if user aren't admin and event doesn't exist user can't register!!)
			 */
			try {
